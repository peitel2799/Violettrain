        ...
        <div className="bg-white rounded-2xl border border-white/10 shadow-xl shadow-violet-950/50 p-8">
          ...
          <div className="mt-6 pt-6 border-t border-gray-100">
            <p className="text-xs text-gray-400 text-center">
              Default credentials: <code className="bg-gray-100 px-1.5 py-0.5 rounded font-mono">violet</code> / <code className="bg-gray-100 px-1.5 py-0.5 rounded font-mono">violet</code>
            </p>
          </div>
        </div>
