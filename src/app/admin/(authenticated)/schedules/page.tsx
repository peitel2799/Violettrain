...
export default function AdminSchedulesPage() {
  ...
  const handleSave = async (scheduleId: string) => {
    ...
    } catch { setMessage('Không thể cập nhật lịch trình') }
  ...
  const handleAdd = async () => {
    ...
    try {
      ...
      if (res.ok || res.status === 201) {
        ...
        setAddError(data.error || 'Không thể thêm lịch trình.')
      }
    } catch {
      setAddError('Không thể thêm lịch trình.')
    } finally {
      setSaving(false)
    }
  }
  ...
  return (
    <div className="p-6 lg:p-8">
      <div className="flex items-center justify-between mb-6">
        <div>
          <h1 className="text-2xl font-bold text-gray-900" style={{ fontFamily: 'var(--font-serif)' }}>Lịch trình</h1>
          <p className="text-sm text-gray-500 mt-0.5">Quản lý lịch trình tàu và tình trạng ghế.</p>
        </div>
      ...
      <div className="flex flex-wrap gap-3 mb-6">
        <div>
          <label className="block text-xs font-medium text-gray-500 mb-1">Lọc theo ngày</label>
        ...
        <div>
          <label className="block text-xs font-medium text-gray-500 mb-1">Lọc theo tuyến</label>
      ...
      {loading ? (
        ...
        <div className="text-center py-16">
          ...
          <p className="text-gray-400 text-sm">Không tìm thấy lịch trình nào</p>
        </div>
      ) : (
          ...
          <table className="w-full text-sm">
            <thead>
              <tr className="text-left text-xs text-gray-500 uppercase bg-gray-50">
                <th className="px-5 py-3 font-medium">Tàu</th>
                ...
                <th className="px-5 py-3 font-medium">Giờ</th>
                <th className="px-5 py-3 font-medium">Ghế</th>
          ...
          <div className="bg-white rounded-2xl shadow-2xl w-full max-w-lg mx-4 overflow-hidden max-h-[90vh] overflow-y-auto">
            ...
            <div className="p-6 space-y-4">
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-1.5">Số hiệu tàu *</label>
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-1.5">Ga đi *</label>
                ...
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-1.5">Ga đến *</label>
                  <input type="text" value={addValues.toStation}
                    onChange={(e) => setAddValues((v) => ({ ...v, toStation: e.target.value }))}
                    placeholder="VD: Ga Lào Cai (Sapa)"
                    className="w-full border border-gray-200 rounded-xl px-3 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-violet-500" />
                </div>
              </div>
              <div className="grid grid-cols-3 gap-4">
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-1.5">Khởi hành *</label>
