...
function AdminSidebar({
  ...
  const navItems = [
    { href: '/vi/admin', label: tNav('dashboard'), icon: LayoutDashboard },
    { href: '/vi/admin/bookings', label: tNav('bookings'), icon: Ticket },
    { href: '/vi/admin/routes', label: tNav('routes'), icon: Train },
    { href: '/vi/admin/pricing', label: tNav('pricing'), icon: Tag },
    { href: '/vi/admin/schedules', label: tNav('schedules'), icon: Calendar },
    { href: '/vi/admin/settings', label: tNav('settings'), icon: Settings },
  ]
